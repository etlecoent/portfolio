  ...
  return (
    <footer className="bg-white dark:bg-gray-800 w-full py-8">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="pt-8 flex mx-auto items-center justify-evenly">
          <a href="https://github.com/Deteri0n" className="text-gray-400 dark:hover:text-white hover:text-gray-800 transition-colors duration-200">
          ...
          <a href="https://www.linkedin.com/in/etienne-le-coent/" className="text-gray-400 dark:hover:text-white hover:text-gray-800 transition-colors duration-200">
